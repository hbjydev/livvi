...
fn impl_tool(args: ToolArgs, input_fn: ItemFn) -> syn::Result<proc_macro2::TokenStream> {
    ...
    let handler_impl = quote! {
        ...
        impl #crate_path::tool::ToolHandler for #wrapper_name {
            ...
            async fn call(&self, ctx: &#crate_path::tool::ToolContext<'_>, args: #crate_path::serde_json::Value) -> #crate_path::tool::ToolCallOutput {
                #extraction
